...
namespace Acme.Biz
{
    ...
    public class Vendor
    {
                                            ...
                                            string instructions = "standard delivery")
        {
            ...
            var success = false;
            //stringbuilder importane para concatenar muchos string y que va a comer mucha memoria
            //esto hace que no se cree obj string acada rato y hace que no se comamla memoria y procesamiento 
